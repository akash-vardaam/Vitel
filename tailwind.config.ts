  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "data-rose": {
          DEFAULT: "hsl(var(--data-rose))",
          dim: "hsl(var(--data-rose-dim))",
        },
        popover: {
      ...
      backgroundImage: {
        ...
        "glow-amber": "var(--gradient-glow-amber)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 12px hsl(170 48% 51% / 0.2)" },
          "50%": { boxShadow: "0 0 32px hsl(170 48% 51% / 0.5)" },
        },
        "shimmer": {
